const { newEventFromMessage, events} = require("../../utilities/events");
...
//READ COMMENTS FOR YOUR HEALTH, WE ARE NEURODIVERSE AND WE MADE OUR BEST FOR YOU
            if(ctx.update.channel_post.chat.username === process.env.DEBUG_CHANNEL_ID || ctx.update.channel_post.chat.username === process.env.CHANNEL_ID){//.username looks at the public tag of the channel, .id is the unique id between the bot and the channel
